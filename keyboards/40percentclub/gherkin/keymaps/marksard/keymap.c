...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
       KC_11CT,  KC_12AL,   KC_ESC,   KC_TAB,  _______,  KC_MLAD,    KANJI,   KC_DEL,  JP_BSLS,   KC_GRV
  //`---------+---------+---------+---------+---------+---------+---------+---------+---------+---------'
  ),
  ...
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
       KC_LCTL,  KC_LALT,  KC_LGUI,  XXXXXXX,  KC_MLAD,  _______,  JP_BSLS,  KC_COMM,   KC_DOT,  KC_SSCT
  //`---------+---------+---------+---------+---------+---------+---------+---------+---------+---------'
  ),
